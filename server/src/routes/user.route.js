...
router.post(
    ...
    body("confirmPassword")
        ...
        .isLength({min: 8}).withMessage("confirmPassword minium 8 characters")
        .custom((value, { req }) => {
    ...
    body("diaplayName")
        ...
        .isLength({min: 8}).withMessage("displayName minium 8 characters"),
...
router.put(
    ...
    body("newPassword")
        ...
        .isLength({min: 8}).withMessage("newPassword minium 8 characters"),
    body("confirmNewPassword")
        .exists().withMessage("confirmNewPassword is required")
        .isLength({min: 8}).withMessage("confirmNewPassword minium 8 characters")
        .custom((value, { req }) => {
...
router.post(
    ...
    body("mediaId")
        .exists().withMessage("mediaId id required")
